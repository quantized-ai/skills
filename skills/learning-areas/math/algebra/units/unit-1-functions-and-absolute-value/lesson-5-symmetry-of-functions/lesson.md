...
Begin with domain symmetry, not algebraic substitution. Teach algebraic, tabular, and graphical evidence as representations of the same definitions. During practice, distinguish a sign-manipulation error from insufficient evidence. Assess with fresh functions and require justification; a visual label without domain or identity evidence is insufficient.
