# Tutor: Lesson 1.5: Symmetry of functions
...
Curriculum reference: **Even and odd functions** in the [concept table](lesson.md#concepts). Use that row’s Content and Proficiency criteria; the checklist below specifies evidence collection for it.
...
- algebraic even and odd classifications, connected to their graph symmetries;
