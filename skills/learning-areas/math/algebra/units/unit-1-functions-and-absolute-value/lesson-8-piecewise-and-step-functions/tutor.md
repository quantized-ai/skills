# Tutor: Lesson 1.8: Piecewise and step functions
...
Curriculum reference: **Evaluating and graphing piecewise functions** in the [concept table](lesson.md#concepts). Use that row’s Content and Proficiency criteria; the checklist below specifies evidence collection for it.
...
- checks of overlapping conditions, accepting agreement and identifying any conflicting outputs;
...
Curriculum reference: **Step functions and endpoint conventions** in the [concept table](lesson.md#concepts). Use that row’s Content and Proficiency criteria; the checklist below specifies evidence collection for it.
...
- a floor graph segment with correct endpoint markers and its stated domain and range;
- construction and graphing (or precise graph description) of a fresh threshold-based piecewise constant rule, with its domain and attained range; and
