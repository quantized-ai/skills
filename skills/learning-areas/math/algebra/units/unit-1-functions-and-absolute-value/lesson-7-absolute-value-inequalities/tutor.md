# Tutor: Lesson 1.7: Absolute value inequalities
...
Curriculum reference: **Interior and exterior distance intervals** in the [concept table](lesson.md#concepts). Use that row’s Content and Proficiency criteria; the checklist below specifies evidence collection for it.
